 ...
 * @ClassName toolkit.encryption.Base58
 * @Data 2019/11/8 11:23
 * @Auther Luo
 **/
...
public class Base58 {
    ...
    public static byte[] decode(String input) {
        ...
        for (int i = 0; i < input.length(); ++i) {
            ...
            if (digit58 < 0) {
                throw new RuntimeException("Not a toolkit.encryption.Base58 input: " + input);
            }
     ...
     * @return toolkit.encryption.Base58 string
     */
     ...
     * base58 to string
     *
     * @param base58Str toolkit.encryption.Base58 string
